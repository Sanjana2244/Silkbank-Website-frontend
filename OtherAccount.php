...
<div class="side-bar">
    <div class="page_width">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="other-account-page">
                    <h3>Other Accounts</h3>
                    <p>Silkbank welcomes you to a world of convenience and security. Our Credit cards offer premium features, outstanding services and exciting discounts liberating our customers to enjoy a comfortable lifestyle. Silkbank has ventured into following variants of Credit Cards:</p>

                </div>
                <div class="other-account-Tabs-section">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link active show" data-toggle="tab" href="#foregincurrencyaccount">Foreign Currency Account</a>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#remittances">Remittances</a>
                        </li> -->

                    </ul>
                </div>
                <div class="tab-content">
                    <div class="tab-pane active" id="foregincurrencyaccount">
                        <div class="Tabforegincurrencyaccount">
                            <img class="my-4" src="assets/images/Loan Slider.png" alt="image" width="100%">
                            <div class="TabHeading d-block mb-2">Foreign Currency Accounts</div>
                            <div class="TabPara">
                                <p>Invest in our Foreign Currency Account to earn remarkable profits twice a year.</p>


                            </div>

                            <div class="tabmiddlepara">
                                <p>Profit calculated on the minimum balance during the month</p>
                                <p>Profit credited after every 6 months</p>
                                <p>Can be operated by individuals or companies</p>
                            </div>
                            <div class="lastpara">
                            ...
                            <div class="d-lg-flex">
                                ...
                                <div class="button-container">
                                    ...
                                    <a class="Button" href="./assets/pdf/foreigncurrency1Indicative Profit Rates for Deposit Products effective 1st January 2019 - Final.pdf" target="blank">Profit Rate Sheet</a>
                                </div>
                                <div class="button-container">


                                    <a class="Button" href="./assets/pdf/foreigncurrency210785-SOC Booklet for Silkbank Jul-Dec 15.pdf" target="blank">Schedule of Charges</a>
                                </div>
                            </div>
                        </div>

                    </div>
                    <!-- <div class="tab-pane fade" id="remittances">
                        <div class="Tabremittances">
                            <img class="my-4" src="assets/images/onlineExpress-banner.png" alt="image" width="100%">
                            <div class="TabHeading mb-2">Become a Silkbank Agent</div>
                            <div class="TabPara">
                                <p>If any Bank, Exchange Company or Money Transfer Company would like to establish home remittance arrangements with Silkbank, then please feel free to contact the following:</p>

                            </div>


                            <div class="lastpara">
                                <p>Designation: Business Head – Home Remittance/ADC Department</p>
                                <p>Office Telephone No.: (+92)-21-35312192-4</p>
                                <p>UAN.: (+92)-21-111-100-777 (214, 222)</p>
                                <p>No.: (+92)-21-32460047</p>
                                <p>Email Address: Pri.cpu@silkbank.com.pk</p>

                            </div>
                            <div class="TabHeading mb-2">Silk Fauree Transfer</div>
                            <div class="TabPara">
                            ...
                            <div class="TabHeading mb-2 mt-4">Western Union</div>
                            <div class="TabPara">
                                <p>Send your remittances to your loved ones in Pakistan from any corner of the world through Western Union. The payment can be collected instantly from any of the Silkbank branches.</p>
                                <p>The beneficiary is required to submit the following information at Silkbank counters:</p>

                            </div>
                            <div class="tabmiddlepara">
                                <p>1. Country of origin of funds</p>
                                <p>2. Amount to be received</p>
                                <p>3. Sender’s full name</p>
                                <p>4. Receiver’s full name
                                </p>
                                <p>5. Transaction Reference No. </p>



                            </div>
                            <div class="TabPara">
                                <p>No account with Silkbank is necessary to collect Western Union remittance.</p>
