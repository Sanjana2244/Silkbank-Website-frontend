            ...
            <div class="col-lg-9">
                <div class="loan-page-Tabs-section">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#Consumer">Consumer</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active show" data-toggle="tab" href="#SME">SME</a>
                        </li>
                    </ul>
                </div>
                <div class="tab-content">
                    <div class="tab-pane container fade p-lg-2 p-0" id="Consumer">
                        <div class="Tabconsumer">
                            ...
                            <div class="tab-content" id="content-container17" role="tablist">
                                <div class="card tab-pane fade show active" id="personalloan" role="tabpanel" aria-labelledby="tab-loan">
                                    ...
                                    <div id="collapse-A" class="collapse show " data-parent="#content-container17" role="tabpanel" aria-labelledby="heading-A">
                                        <div class="Tabpersonalloan card-body">
                                            ...
                                            <div class="tabmiddlepara">
                                                <p>Have one time borrowing need</p>
                                                <p>Want the peace of mind through monthly payments</p>
                                            ...
                                            <div class="tabmiddlepara">
                                                <p>Pakistani residents</p>
                                                <p>Foreign nationals with approved company guarantee

                                                </p>
                                                <p>Salaried individuals
                                                </p>
                                                <p>
                                                    Age: 21-65 years
                                                </p>
                                                <p>Income: minimum Rs. 40,000/- monthly</p>
                                                <p>Offered in major cities of Pakistan: Karachi, Lahore, Rawalpindi,
                                                    Islamabad, Hyderabad, Peshawar, Multan & Faisalabad.</p>
                                            ...
                                            <div class="tabmiddlepara">
                                                <p class="mb-5">Monthly installments with Pre-payment and Partial Payment
                                                    Facility</p>
                                ...
                                <div class="card tab-pane fade" id="personalloansmartplan" role="tabpanel" aria-labelledby="tab-smart">
                                    ...
                                    <div id="collapse-B" class="collapse " data-parent="#content-container17" role="tabpanel" aria-labelledby="heading-B">
                                ...
                                <div class="card tab-pane fade" id="readyline" role="tabpanel" aria-labelledby="tab-ready">
                                    ...
                                    <div id="collapse-C" class="collapse " data-parent="#content-container17" role="tabpanel" aria-labelledby="heading-C">
                                        <div class="Tabreadyline card-body">
                                            ...
                                            <div class="tabmiddlepara">
                                                <p>Be a Pakistani national residing in Karachi, Lahore, Rawalpindi,
                                                    Islamabad, Hyderabad, Peshawar or Faisalabad.</p>
                                                <p>Salaried Individual with a minimum monthly income of Rs 40,000

                                                </p>
                                                <p>Be 21 to 65 years of age
                                                </p>
                                            </div>
                                            <div class="tabMiddleHeading mt-4">
                                                <p>Contact Us:</p>
                    ...
                    <div class="tab-pane container active p-lg-2 p-0 " id="SME">
                        <div class="TabSME">
                            ...
                            <div class="tab-content" id="content-container18" role="tablist">
                                <div class="card tab-pane fade show active" id="MPower" role="tabpanel" aria-labelledby="tab-power">
                                    ...
                                    <div id="collapse-D" class="collapse show" data-parent="#content-container18" role="tabpanel" aria-labelledby="heading-D">
                                        <div class="TabMPower card-body">
                                            ...
                                            <div class="tabmiddlepara">
                                                <p>To avail the M’Power facility you should</p>
                                                <ul class="list-group">
                                ...
                                <div class="card tab-pane fade" id="SMECashEase" role="tabpanel" aria-labelledby="tab-cash">
                                    ...
                                    <div id="collapse-E" class="collapse" data-parent="#content-container18" role="tabpanel" aria-labelledby="heading-E">
                                ...
                                <div class="card tab-pane fade" id="SMERelationship" role="tabpanel" aria-labelledby="tab-relationship">
                                    ...
                                    <div id="collapse-F" class="collapse " data-parent="#content-container18" role="tabpanel" aria-labelledby="heading-F">
                                ...
                                <div class="card tab-pane fade" id="SMEAgri" role="tabpanel" aria-labelledby="tab-agri">
                                    ...
                                    <div id="collapse-G" class="collapse " data-parent="#content-container18" role="tabpanel" aria-labelledby="heading-G">
