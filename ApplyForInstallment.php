...
<div class="side-bar">
    <div class="page_width">
        <div class="breadcrumbs">
            <!-- <p class="text-uppercase mb-0"> HOME &nbsp;/ &nbsp; Cards &nbsp;/ &nbsp; credit cards &nbsp;/ <br><span>apply for installment plan</span></p> -->
            <p class="text-uppercase mb-0"><a href="./index.php">HOME</a> &nbsp;/ &nbsp;<a href="./cards.php">Cards</a> &nbsp;/ &nbsp; <a href="./cards.php">credit cards</a> &nbsp;/ <br><span><a href="./ApplyForInstallment.php">apply for installment plan</a></span></p>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-12 apply-online">
                <div class="form-heading">
                    <h3 class="mb-4">Apply For Installment Plan</h3>

                </div>
                <div class="m-lg-0 mx-4">

                    <div class="form-group row col-lg-12 col-md-12 col-12  p-0 mb-4 ">
                        ...
                        <div class="col-md-6 ">
                            <input class="form-control" placeholder="Your City" name="Contact[Your City]" id="Contact_last_name" type="text">
                    ...
                    <div class="form-group row col-lg-12 col-md-12 col-12  p-0 mb-4">
                        <div class=" col-md-6 pl-0 m-lg-0  mb-4">
                            <input class="form-control" placeholder="Enter Your Contact Number" name="Contact[Enter Your Contact Number]" id="Contact_first_name" type="text">
                        </div>
                        <div class="col-md-6">
                            <input class="form-control" placeholder="Monthly Salary in PKR" name="Contact[last_name]" id="Contact_last_name" type="text">
                    ...
                    <div class="form-group row col-lg-12 col-md-12 col-12  p-0 mb-4">
                        <div class="col-md-6 pl-0 m-lg-0  mb-4">
                            <input class="form-control" placeholder="Company Name" name="Contact[first_name]" id="Contact_first_name" type="text">


                        </div>
                        <div class="col-md-6">
                            <select class="form-control" name="Contact[reason]" id="Contact_reason">
                                <option value="">Products you are interested in</option>
                    ...
                    <div class="form-group row col-lg-12 col-md-12 col-12  p-0">
                        <div class=" col-md-6 pl-0 ">
                            <input class="form-control m-lg-0  mb-4" placeholder="Choose a date on to schedule" name="Contact[first_name]" id="Contact_first_name" type="text">
                            <p class="form-dark-text  pl-3 mt-2">**Select preferred Call Back Date</p>


                        </div>
                        <div class="col-md-6">
                            <select class="form-control m-lg-0  mb-4" name="Contact[reason]" id="Contact_reason">
                            ...
                            <p class="form-dark-text pl-3 mt-2 mb-0">**preferred Time</p>
